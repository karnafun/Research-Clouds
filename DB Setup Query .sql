...
drop view [dbo].[UserAndTags],[dbo].[v_ArticleKeywords],[dbo].[v_ClusterKeywords],[dbo].[v_InstituteUsers],[dbo].[v_UserAffiliations],[dbo].[v_UserArticles],[dbo].[v_UserClusters]
*/
...
go
select * from v_UserAffiliations where uId = 1
...
('Amit', '', 'Rechavi','Ph.D','https://goo.gl/s235Pe',null,null,0,'emailaddress',null,null,'this is my summery')
insert into users values
